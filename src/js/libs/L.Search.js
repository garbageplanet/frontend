...
////start DOM creations
	...
	_createInput: function (text, className) {
		...
		var input = L.DomUtil.create('input', className + ' input-lg form-control', this._container);
		input.type = 'text';
	...
	_createCancel: function (title, className) {
		...
		cancel.innerHTML = '<span class="fa fa-fw fa-2x fa-spinner fa-pulse"></span>';
	...
	_createButton: function (title, className) {
        ...
        button.innerHTML = '<span class="fa-search fa-fw fa-2x"></span>';
